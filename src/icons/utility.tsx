...
export function IconEmail({ className = "w-4 h-4" }: IconProps) {
  return (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
...
export function IconArrowUpFull({ className = "w-4 h-4" }: IconProps) {
  return (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
...
export function IconCheckFilled({ className = "w-4 h-4" }: IconProps) {
  return (
...
export function IconStatusCheck({ className = "w-4 h-4" }: IconProps) {
  return (
...
export function IconStatusClose({ className = "w-4 h-4" }: IconProps) {
  return (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={3} aria-hidden="true">
