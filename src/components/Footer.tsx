...
export function Footer() {
  ...
  return (
    <footer className="bg-black text-white w-full border-t border-gray-800 bg-dots" style={{ height: '252px' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-none xl:grid-flow-col xl:auto-cols-max gap-x-14.25 gap-y-10 w-fit shrink-0">
          ...
          <div className={sectionBlock}>
            ...
            <div className="flex flex-col gap-0.5 text-gray-300">
              <p className="body-2-regular inline-flex w-fit">Viimati muudetud 1 aasta eest.</p>
              <p className="body-2-regular inline-flex w-fit">Uuendati lehekülge:</p>
              <p className="body-2-regular inline-flex w-fit">
