...
export function QuizIntro({ onStart }: QuizIntroProps) {
  ...
  return (
    <div className="relative bg-white border-2 border-stat-light-grey rounded-2xl p-8 max-[500px]:p-6 max-[400px]:p-5 md:p-12 pb-70 max-[500px]:pb-6">
      ...
      <Button
        onClick={onStart}
        className="absolute right-8 bottom-8 w-27.25 h-13.5 flex flex-col justify-center items-center max-[500px]:static max-[500px]:mt-6 max-[500px]:w-full max-[500px]:h-12"
      >
